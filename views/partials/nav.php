...
<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    ...
    <div class="hidden md:block">
        ...
        <div class="relative ml-3">
            <div>
            <button type="button" class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm  focus:outline-hidden hover:scale-105 transition-transform" id="user-menu-button">
                ...
                <?php else: ?>
                <a href="/register" class="text-gray-700 bg-white rounded-xl shadow-lg  items-center justify-center duration-5 w-24 h-10 flex">Register</a>
                <?php endif; ?>
            </button>
            </div>
